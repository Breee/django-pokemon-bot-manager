...
class FortSightings(models.Model):
    id = models.BigAutoField(primary_key=True)
    fort = models.ForeignKey(Forts, models.CASCADE, unique=True, blank=True, null=True)
...
class GymDefenders(models.Model):
    id = models.BigAutoField(primary_key=True)
    fort = models.ForeignKey(Forts, models.CASCADE, null=True)
...
class Raids(models.Model):
    ...
    fort = models.ForeignKey(Forts, models.CASCADE, blank=True, null=True)
